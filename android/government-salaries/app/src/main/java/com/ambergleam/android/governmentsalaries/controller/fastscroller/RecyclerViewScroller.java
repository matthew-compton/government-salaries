...
/**
 * To be implemented by any object that scrolls a {@link android.support.v7.widget.RecyclerView}
 */
public interface RecyclerViewScroller {

    /**
     * What good is a RecyclerViewScroller without a {@link android.support.v7.widget.RecyclerView}?!
     * @param recyclerView to scroll using the scroller
     */
    public void setRecyclerView(RecyclerView recyclerView);

    /**
     * Since {@link android.support.v7.widget.RecyclerView.OnScrollListener} is not implemented as an interface, RecyclerViewScrollers cannot implement this
     * interface, and in most cases, it makes no sense for them to extend a scroll listener. For this reason, we must
     * provide a listener that is intended to be fetched and set as a listener on a {@link android.support.v7.widget.RecyclerView}.
     *
