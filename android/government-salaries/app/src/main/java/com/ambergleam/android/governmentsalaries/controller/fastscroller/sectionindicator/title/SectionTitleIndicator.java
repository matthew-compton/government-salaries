package com.ambergleam.android.governmentsalaries.controller.fastscroller.sectionindicator.title;
...
import com.ambergleam.android.governmentsalaries.controller.fastscroller.sectionindicator.AbsSectionIndicator;
...
public abstract class SectionTitleIndicator<T> extends AbsSectionIndicator<T> {
    ...
    private static final int DEFAULT_TITLE_INDICATOR_LAYOUT = R.layout.section_indicator;
